...
5. Specify User Details 
    User name: Enter a unique name (e.g., admin-user). Names are not case-sensitive

Note:
You can grant users only the specific permissions they need (e.g., "User A can read S3 but not delete anything"). 
